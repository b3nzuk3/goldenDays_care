  ...
  const services = [
    {
      icon: Heart,
      title: "Personal Care",
      description: "Compassionate assistance with daily living activities in a warm, home-like environment.",
      features: [
    ...
    },
    {
      icon: Stethoscope,
      title: "Medical Care",
      description: "Professional healthcare services coordinated with your loved one's medical team.",
      features: [
    ...
    },
    {
      ...
      description: "Engaging programs that promote social interaction and mental stimulation.",
      features: [
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We provide comprehensive care tailored to each resident's unique needs, 
              ensuring comfort, dignity, and peace of mind for families.
            </p>
          </div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Small, intimate setting</strong> with only 6 residents for personalized attention
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-6 w-6 text-warm-accent mt-0.5 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Licensed professionals</strong> with over 15 years of eldercare experience
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-6 w-6 text-warm-accent mt-0.5 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Family-centered approach</strong> with open communication and regular updates
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-6 w-6 text-warm-accent mt-0.5 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Beautiful home environment</strong> with private rooms and comfortable common areas
                  </p>
                </div>
              </div>
            ...
            <Card className="text-center p-8">
              <CardContent className="pt-6">
                ...
                <blockquote className="text-lg md:text-xl text-muted-foreground mb-6 italic">
                  "Golden Days AFH gave our family peace of mind during a difficult time. 
                  The staff treats every resident like family, and Mom has never been happier. 
      ...
      <section className="py-20 bg-warm-accent">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            ...
            We're here to answer all your questions and help you make the best decision for your loved one.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-warm-accent">
      ...
      <footer className="bg-primary text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-white/80">
                Providing compassionate, dignified care in a home-like environment since 2015.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/80">
                <li>(555) 123-4567</li>
                <li>info@goldendaysafh.com</li>
                <li>123 Care Lane</li>
                <li>Peaceful Valley, WA 98001</li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center text-white/60">
            <p>&copy; 2024 Golden Days Adult Family Home. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
